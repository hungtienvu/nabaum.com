...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content add_item">
            <h1><strong><?php _e('Publish a listing', 'usa'); ?></strong></h1>
            <ul id="error_list"></ul>
            <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="page" value="item" />
                    <div class="box general_info">
                        ...
                        <div class="row">
                            <label for="catId"><?php _e('Category', 'usa'); ?> *</label>
                    ...
                    <div class="box price">
                        <label for="price"><?php _e('Price', 'usa'); ?></label>
                    ...
                    <div class="box location">
                        <h2><?php _e('Listing Location', 'usa'); ?></h2>
                        <div class="row">
                            <label for="countryId"><?php _e('Country', 'usa'); ?></label>
                            <?php ItemForm::country_select(osc_get_countries(), osc_user()); ?>
                        </div>
                        <div class="row">
                            <label for="regionId"><?php _e('Region', 'usa'); ?></label>
                        ...
                        <div class="row">
                            <label for="city"><?php _e('City Area', 'usa'); ?></label>
                    ...
                    <div class="box seller_info">
                        <h2><?php _e("Seller's information", 'usa'); ?></h2>
                        <div class="row">
                            <label for="contactName"><?php _e('Name', 'usa'); ?></label>
                            <?php ItemForm::contact_name_text(); ?>
                        </div>
                        <div class="row">
                            <label for="contactEmail"><?php _e('E-mail', 'usa'); ?> *</label>
                        ...
                        <div class="row">
                            ...
                            <label for="showEmail" style="width: 250px;"><?php _e('Show e-mail on the listing page', 'usa'); ?></label>
                        </div>
                    </div>
                    <?php }; ?>
                    ...
                    <?php }?>
                <div class="clear"></div>
                <button  type="submit"><?php _e('Publish', 'usa'); ?></button>
                </fieldset>
            </form>
        </div>
